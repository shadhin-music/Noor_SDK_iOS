...
#define MarqueeLabel DNMarqueeLabel
#define MarqueeType DNMarqueeType
#define MLLeftRight DNMLLeftRight
#define MLRightLeft DNMLRightLeft
#define MLContinuous DNMLContinuous
#define MLContinuousReverse DNMLContinuousReverse
#define MLLeft DNMLLeft
#define MLRight DNMLRight
#define GradientSetupAnimation DNGradientSetupAnimation
