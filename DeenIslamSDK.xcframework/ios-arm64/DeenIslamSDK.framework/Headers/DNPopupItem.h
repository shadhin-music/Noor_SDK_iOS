...
NS_SWIFT_UI_ACTOR
/// An `DNPopupItem` object manages the buttons and text to be displayed in a popup bar. Each view controller in popup presentation must have an `DNPopupItem` object that contains the buttons and text it wants displayed in the popup bar.
@interface DNPopupItem : NSObject
...
///
/// See `DNPopupBarAppearance.standardAppearance` for further details.
@property (nonatomic, readwrite, copy, nullable) DNPopupBarAppearance* standardAppearance;

@end

@interface DNPopupItem (Accessibility)
...
@interface DNPopupItem (Deprecated)

@property(nullable, nonatomic, copy) NSArray<UIBarButtonItem*>* leftBarButtonItems DN_UNAVAILABLE_API("Use leadingBarButtonItems instead.");

@property(nullable, nonatomic, copy) NSArray<UIBarButtonItem*>* rightBarButtonItems DN_UNAVAILABLE_API("Use barButtonItems or trailingBarButtonItems instead.");
