//
//  DNPopupBarContentViewController.h
//  DNPopupController
//
...
@interface DNPopupCustomBarViewController : UIViewController <UIPointerInteractionDelegate>

/// The containing popup bar. (read-only)
@property (nonatomic, weak, readonly, nullable) DNPopupBar* dncontainingPopupBar;

/// Indicates whether the default tap gesture recognizer should be added to the popup bar.
///
/// Defaults to `true`.
@property (nonatomic, assign, readonly) BOOL dnwantsDefaultTapGestureRecognizer;

/// Indicates whether the default pan gesture recognizer should be added to the popup bar.
///
/// Defaults to `true`.
@property (nonatomic, assign, readonly) BOOL dnwantsDefaultPanGestureRecognizer;

/// Indicates whether the default highlight gesture recognizer should be added to the popup bar.
///
/// Defaults to `true`.
@property (nonatomic, assign, readonly) BOOL dnwantsDefaultHighlightGestureRecognizer;
...
@property (nonatomic, assign) CGSize dnpreferredContentSize;
...
- (void)dnactiveAppearanceDidChange:(DNPopupBarAppearance*)activeAppearance;
