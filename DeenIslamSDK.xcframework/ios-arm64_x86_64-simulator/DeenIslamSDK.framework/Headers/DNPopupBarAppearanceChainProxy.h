//
//  DNPopupBarAppearanceChainProxy.h
//  DNPopupBarAppearanceChainProxy
//
...
@interface DNPopupBarAppearanceChainProxy : NSObject
...
- (void)setChainDelegate:(nullable id<_DNPopupBarAppearanceDelegate>)delegate;
